...
class RequesterRepository extends ServiceEntityRepository
{
    ...
    public function add(Requester $entity, bool $flush = false): void
    {
    ...
    public function remove(Requester $entity, bool $flush = false): void
    {
    ...
    public function findBloodGroupNames()
    {
